...
func Provider() *schema.Provider {
	...
	return &schema.Provider{
		...
		DataSourcesMap: map[string]*schema.Resource{
			...
			"gitea_org_webhook":                       dataSourceGiteaOrgWebhook(),
			"gitea_org_webhooks":                      dataSourceGiteaOrgWebhooks(),
			"gitea_label":                             dataSourceGiteaLabel(),
			"gitea_labels":                            dataSourceGiteaLabels(),
			"gitea_milestone":                         dataSourceGiteaMilestone(),
			"gitea_milestones":                        dataSourceGiteaMilestones(),
			"gitea_release":                           dataSourceGiteaRelease(),
			"gitea_releases":                          dataSourceGiteaReleases(),
			"gitea_repository_tag":                    dataSourceGiteaRepositoryTag(),
			"gitea_repository_tags":                   dataSourceGiteaRepositoryTags(),
			"gitea_repository_topics":                 dataSourceGiteaRepositoryTopics(),
		},
		...
		ResourcesMap: map[string]*schema.Resource{
			...
			"gitea_org_webhook":                       resourceGiteaOrgWebhook(),
			"gitea_label":                             resourceGiteaLabel(),
			"gitea_milestone":                         resourceGiteaMilestone(),
			"gitea_release":                           resourceGiteaRelease(),
			"gitea_repository_tag":                    resourceGiteaRepositoryTag(),
